...
public class Agenetico {
    ...
    public void configurar(int genes, int poblacionInicial,
            int iteracionGeneracion, int evolucion) {
        try {
            ...
            conf_poblacion(config, poblacionInicial,
                    iteracionGeneracion, evolucion);
    ...
    private void ver_individuo(IChromosome ic) {
       ...
       int y4 = (int) ic.getGene(7).getAllele();
        ...
        System.out.println("x1: "+x_valor+" x2: "+y_valor);
        System.out.println("**************");
    }
}
